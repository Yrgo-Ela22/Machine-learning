...
class DenseLayer {
  public:
     ...
     ********************************************************************************/
    const std::vector<double>& Output(void) const { return output_; }
     ...
     * 
     * @param inputs
     *        Reference to vector holding the new input values.
     ********************************************************************************/
     ...
     * 
     * @param reference
     *        Reference to vector holding the reference values.
     ********************************************************************************/
     ...
     * 
     * @param inputs
     *        Reference to vector holding the input values (for adjusting weights).
     * @param learning_rate
     *        Learning rate, indicates the amount of adjustment (default = 1 %).
     ********************************************************************************/
